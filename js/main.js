  ...
  function buildHeader() {
    ...
    el.innerHTML = `
      <div class="header-inner">
        <a href="index.html" class="logo" aria-label="Hazel Media">
          <svg class="logo-icon" viewBox="0 0 32 32" aria-hidden="true">
            <rect x="1.5" y="1.5" width="29" height="29" rx="7" fill="#1D1168"/>
            <rect x="7" y="7" width="18" height="18" rx="3" fill="none" stroke="#FCF8F2" stroke-width="1.6"/>
            <circle cx="16" cy="16" r="3.4" fill="#D81746"/>
          </svg>
          <span class="logo-text">
            <strong>Hazel Media</strong>
            <small>Verhalen in Beeld</small>
          </span>
        </a>
